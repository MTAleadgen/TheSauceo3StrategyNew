...
SYSTEM_PROMPT = (
    ...
    "6. Decide if this event is a dance event or a concert in a dance genre. Use this list of dance styles (not exhaustive): Afrobeat / Afro-Fusion, Argentine Tango, Azonto, Bachata, Balboa, Ballet, Belly Dance, Bhangra, Bolero, Brazilian Zouk, Breaking (B-boying), Capoeira, Charleston, Cha-Cha-Cha, Collegiate Shag, Contemporary, Country Two-Step, Cumbia, Dancehall, East Coast Swing, Flamenco, Forró, Foxtrot, Heels Dance, Hip-Hop (freestyle / new-style), House Dance, Hustle (Disco), Irish Stepdance, Jazz Dance, Jive, K-Pop Choreography, Kizomba, Krump, Kuduro, Lambada, Line Dance, Lindy Hop, Locking, Lyrical Dance, Mambo, Merengue, Modern Dance, Pasodoble, Peabody, Popping, Polka, Quickstep, Rumba, Reggaeton Dance, Samba (no pé / Carnaval), Samba de Gafieira, Salsa, Shuffle Dance (Melbourne Shuffle), Tap Dance, Tango (Ballroom / International Standard), Tutting, Vogue, Waacking, Waltz, West Coast Swing. Return true if yes, false if not.\n"
